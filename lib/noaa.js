...
export default class NOAA {
  ...
  fetchWaterTemperature() {
    const params =
      "?station=" +
      this.stationId +
      "&date=today&range=12&product=water_temperature&interval=h&datum=mllw&units=english&time_zone=gmt&application=web_services&format=json";
    return request(params).then(json => {
