      ...
      resolve(
        _.map(forecast, hour => {
          return {
            ...
            height: hour.swell.maxBreakingHeight,
            direction: hour.swell.components.combined.compassDirection,
            period: hour.swell.components.combined.period,
