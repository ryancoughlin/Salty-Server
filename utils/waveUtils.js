...
const getWaveDataUrl = (stationId) =>
...
const parseWaveData = (data) => {
  ...
  const parseLine = (line) => {
    ...
    const waterTempFahrenheit =
      waterTempCelsius !== null ? (waterTempCelsius * 9) / 5 + 32 : null
  ...
  return lines.map(parseLine).filter((dataPoint) => dataPoint !== null)
}
